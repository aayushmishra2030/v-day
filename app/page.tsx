...
export default function SpaceValentinesLanding() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#0a192f] text-white overflow-hidden relative transition-all duration-500 ease-in-out font-pixel px-4 sm:px-6 lg:px-8">
      <ShootingStars />
      <header className="py-4 flex flex-col sm:flex-row items-center justify-between z-10">
      ...
      <main className="flex-1 relative">
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tighter text-red-400 mb-4">
                  Expressing My Love to You, Cosmically!
                </h1>
                <p className="text-sm sm:text-base md:text-lg text-red-300 max-w-[700px] mx-auto">
        ...
        <section ref={whySendRef} className="w-full py-12 md:py-24 lg:py-32" id="why-send">
          <div className="container px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-center mb-8 text-red-400">
        ...
        >
          <div className="container px-4 md:px-6 relative">
            <h2 className="text-2xl font-bold tracking-tighter sm:text-3xl md:text-4xl text-center mb-8 text-red-400">
              Message for You
            </h2>
